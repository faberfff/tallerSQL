    ...
    values
      ...
      -- inserción datos tabla producto_proveedor 
       ...
       -- inserción datos tabla cliente_usuario  
         ...
         insert into cliente_usuario(id, tipo_documento, num_documento, nombre)
	     values
         (01, 'Cedula', '43789415', 'Diana Lozada'),
		 (02, 'Cedula', '47258963', 'Armando Contreras'),
		 (03, 'Cedula', '68952145', 'Dina Lopez'),
		 (04, 'Cedula', '258456159', 'Carlos Gomez'),  
         (05, 'Cedula', '258200589', 'Luis Perez'); 
         
         -- inserción datos tabla venta
         
         insert into venta(id, fecha_venta, cantidad, cliente_usuario_id)
	     values
         (01, '2022-10-25', 2, 2),
		 (02, '2022-11-15', 2, 3),
		 (03, '2023-09-05', 4, 2),
        ...
        UPDATE producto_proveedor SET nombre_producto = 'Pan Frances', nombre_proveedor = 'Nassi Pan'
        where producto_id = 1 AND proveedor_id = 1;
        
        UPDATE producto_proveedor SET nombre_producto = 'Arroz premium', nombre_proveedor = 'Blanquita'
        where producto_id = 3 AND proveedor_id = 3;
        
        UPDATE producto_proveedor SET nombre_producto = 'Mortadela', nombre_proveedor = 'Dan'
        where producto_id = 5 AND proveedor_id = 5;
        
        -- Borrado fisico
        DELETE from detalle_venta where venta_id = 1;
        
		INSERT INTO producto (fecha_producto, vence_producto, stock)
        values ('2023-09-22', '2024-10-25',  90);
        
        
        -- Borrado lógico
        ALTER TABLE venta add estado INT default 1;
        
        UPDATE venta SET estado = 0 where id = 1;
